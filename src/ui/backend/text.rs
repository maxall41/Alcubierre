...
pub fn draw_text(
    ...
    let font_size = spacing_unit_to_pixels(t.styles.font_size.clone(), window_width, window_height) as f32;
    ...
    match t.styles.alignment {
        ElementAlignment::TopLeft => {
            ...
            glyph.queue(Section {
                ...
                text: vec![Text::new(&value)
                    .with_color([t.styles.color.red as f32 / 255.0, t.styles.color.green as f32 / 255.0, t.styles.color.blue as f32 / 255.0, 1.0])
        ...
        ElementAlignment::TopRight => {
            glyph.queue(Section {
                screen_position: (window_width + left_margin - right_margin,0.0 + top_margin - bottom_margin),
                bounds: (window_width as f32, window_height as f32),
                text: vec![Text::new(&value)
                    .with_color([t.styles.color.red as f32 / 255.0, t.styles.color.green as f32 / 255.0, t.styles.color.blue as f32 / 255.0, 1.0])
                    .with_scale(font_size as f32 * 5.0)],
        ...
        ElementAlignment::BottomRight => {
            glyph.queue(Section {
                screen_position: (window_width + left_margin - right_margin,window_height + top_margin - bottom_margin),
                bounds: (window_width as f32, window_height as f32),
                text: vec![Text::new(&value)
                    .with_color([t.styles.color.red as f32 / 255.0, t.styles.color.green as f32 / 255.0, t.styles.color.blue as f32 / 255.0, 1.0])
                    .with_scale(font_size as f32 * 5.0)],
        ...
        ElementAlignment::BottomLeft => {
            glyph.queue(Section {
                screen_position: (0.0 + left_margin - right_margin,window_height + top_margin - bottom_margin),
                bounds: (window_width as f32, window_height as f32),
                text: vec![Text::new(&value)
                    .with_color([t.styles.color.red as f32 / 255.0, t.styles.color.green as f32 / 255.0, t.styles.color.blue as f32 / 255.0, 1.0])
                    .with_scale(font_size as f32 * 5.0)],
        ...
        ElementAlignment::CenterHorizontal => {
            ...
            glyph.queue(Section {
                screen_position: (0.0 + left_margin - right_margin,0.0 + top_margin - bottom_margin),
                bounds: (window_width as f32, window_height as f32),
                text: vec![Text::new(&value)
                    .with_color([t.styles.color.red as f32 / 255.0, t.styles.color.green as f32 / 255.0, t.styles.color.blue as f32 / 255.0, 1.0])
                    .with_scale(font_size as f32 * 5.0)],
