...
pub fn draw_text(
    ...
    let left_margin =
        spacing_unit_to_pixels(t.styles.margin_left.clone(), window_width, window_height);
    let right_margin =
        spacing_unit_to_pixels(t.styles.margin_right.clone(), window_width, window_height);
    let top_margin =
        spacing_unit_to_pixels(t.styles.margin_top.clone(), window_width, window_height);
    let bottom_margin =
        spacing_unit_to_pixels(t.styles.margin_bottom.clone(), window_width, window_height);
    ...
    match t.styles.alignment {
        ...
        ElementAlignment::TopRight => d.draw_text(
            &value,
        ...
        ElementAlignment::BottomRight => d.draw_text(
            &value,
            window_width + left_margin - right_margin,
        ...
        ElementAlignment::BottomLeft => d.draw_text(
            &value,
        ...
        ElementAlignment::CenterHorizontal => {
            let text_size =
                measure_text_ex(d.get_font_default(), &value, font_size as f32, 0 as f32);
            d.draw_text(
                &value,
                ((window_width / 2) - text_size.x as i32) + left_margin - right_margin,
                0 + top_margin - bottom_margin,
                font_size,
                Color {
                    r: t.styles.color.red,
        ...
        ElementAlignment::CenterVertical => {
            ...
            d.draw_text(
                &value,
                0 + left_margin - right_margin,
                ((window_height / 2) - text_size.y as i32) + top_margin - bottom_margin,
                font_size,
                Color {
                    r: t.styles.color.red,
                    g: t.styles.color.green,
        ...
        ElementAlignment::CenterVerticalAndHorizontal => {
            let text_size =
                measure_text_ex(d.get_font_default(), &value, font_size as f32, 5.0 as f32);
            d.draw_text(
                &value,
                ((window_width / 2) - text_size.x as i32 / 2) + left_margin - right_margin,
                ((window_height / 2) - text_size.y as i32) + top_margin - bottom_margin,
                font_size,
                Color {
                    r: t.styles.color.red,
